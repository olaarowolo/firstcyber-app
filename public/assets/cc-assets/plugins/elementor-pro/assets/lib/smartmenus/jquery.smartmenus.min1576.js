 ...
 * Copyright Vasil Dinkov, Vadikom Web Ltd. http://vadikom.com; Licensed MIT */ !(function (
    ...
    return (
            ...
            prototype: {
                    ...
                    if (!c) {
                        ...
                        this.$root
                            ...
                            .on(
                                d(
                                    {
                                        "mouseover focusin": a.proxy(
                                            this.rootOver,
                                            this
                                        ),
                                        "mouseout focusout": a.proxy(
                                            this.rootOut,
                                            this
                                        ),
                                        keydown: a.proxy(
                            ...
                            a(window).on(
                                d(
                                    {
                                        "resize orientationchange": a.proxy(
                                            this.winResize,
                                            this
                                        ),
                                    },
                ...
                getOffset: function (a, b) {
                    ...
                    return (
                        e ||
                            0 === e ||
                            (e = b ? a[0].offsetHeight : a[0].offsetWidth),
                        c && a.hide().css(c),
                        e
                    );
                },
                getStartZIndex: function (a) {
                    var b = parseInt(
                        this[a ? "$root" : "$firstSub"].css("z-index")
                    );
                    return (
                        !a &&
                            isNaN(b) &&
                            (b = parseInt(this.$root.css("z-index"))),
                        isNaN(b) ? 1 : b
                    );
                },
                ...
                itemActivate: function (b, c) {
                    ...
                    if (
                        ...
                        this.$root.triggerHandler("activate.smapi", b[0]) !==
                            !1)
                    ) {
                        var g = b.dataSM("sub");
                        g &&
                ...
                itemClick: function (b) {
                    ...
                    if (this.handleItemEvents(c)) {
                        ...
                        if (
                            this.$root.triggerHandler("click.smapi", c[0]) ===
                            !1
                        )
                            return !1;
                        var d = c.dataSM("sub"),
                ...
                menuHide: function (b) {
                    if (
                        this.$root.triggerHandler("beforehide.smapi", b[0]) !==
                            !1 &&
                ...
                menuPosition: function (b) {
                    ...
                    if (
                        (w
                            ? ((c = x ? p - k - y : y),
                              (e = this.opts.bottomToTopSubMenus
                                  ? -l - z
                                  : q + z))
                            : ((c = x ? y - k : p - y),
                              (e = this.opts.bottomToTopSubMenus
                                ...
                                (b
                                    ...
                                    .css({
                                        ...
                                        width:
                                            ...
                                            (parseInt(
                                                b.css("border-right-width")
                                            ) || 0),
                                        zIndex: b.css("z-index"),
                                    })
                                    .eq(
                                        w && this.opts.bottomToTopSubMenus
                                            ? 0
                                            : 1
                                    )
                                    .show(),
                ...
                menuScrollOver: function (b, c) {
                    if (
                        ...
                        b.dataSM("scroll-arrows")
                            ...
                            .css(
                                "margin-top",
                                e + this.getViewportHeight() - d.arrowDownH
                            )
                            .end()
                ...
                menuShow: function (a) {
                    if (
                        ...
                        this.$root.triggerHandler("beforeshow.smapi", a[0]) !==
                            !1 &&
        ...
        (a.fn.dataSM = function (a, b) {
            return b
                ? this.data(a + "_smartmenus", b)
                : this.data(a + "_smartmenus");
        }),
        ...
        (a.fn.smartmenus = function (b) {
            ...
            return this.each(function () {
                ...
                c &&
                    ...
                    new a.SmartMenus(
                        this,
                        a.extend({}, a.fn.smartmenus.defaults, b, c)
                    );
            });
        }),
