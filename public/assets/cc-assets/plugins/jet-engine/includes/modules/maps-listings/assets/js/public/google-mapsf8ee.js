...
JetGMInfoBox.prototype.addEventListener = function (
    target,
    type,
    handler,
    useCapture
...
JetGMInfoBox.prototype.createJetGMInfoBoxDiv_ = function () {
    ...
    var cancelHandler = function (e) {
        var hasListingOverlay =
            "click" === e.type &&
            e.currentTarget.querySelector(".jet-engine-listing-overlay-wrap");
        ...
        if (!this.enableEventPropagation_) {
            ...
            for (i = 0; i < events.length; i++) {
                this.eventListeners_.push(
                    this.addEventListener(this.div_, events[i], cancelHandler)
                );
            }
            ...
            this.eventListeners_.push(
                this.addEventListener(this.div_, "mouseover", function (e) {
                    this.style.cursor = "default";
                })
            );
        }

        this.contextListener_ = this.addEventListener(
            this.div_,
            "contextmenu",
            ignoreHandler
        );
...
JetGMInfoBox.prototype.addClickHandler_ = function () {
    ...
    if (this.closeBoxURL_ !== "") {
        ...
        this.closeListener_ = this.addEventListener(
            closeBox,
            "click",
...
(function () {
    function t(t) {
        ...
        (this.ready_ = !1),
            ...
            null == t.shadow && (t.shadow = "7px -3px 5px rgba(88,88,88,0.7)"),
            null == t.anchor && (t.anchor = e.BOTTOM),
            this.setValues(r);
    }
    (t.prototype = new google.maps.OverlayView()),
        ...
        (t.prototype.visible_changed = function () {
            this.ready_ &&
        ...
        (t.prototype.visible_changed = t.prototype.visible_changed),
        ...
        (t.prototype.getWidth = t.prototype.getWidth),
        (t.prototype.getHeight = function () {
            return this.get("height");
        }),
        (t.prototype.getHeight = t.prototype.getHeight),
        ...
        (t.prototype.flat_changed = function () {
            this.ready_ &&
        ...
        (t.prototype.flat_changed = t.prototype.flat_changed),
        ...
        (t.prototype.zIndex_changed = function () {
            this.getZIndex() &&
                this.ready_ &&
                (this.markerWrapper_.style.zIndex = this.getZIndex());
        }),
        (t.prototype.zIndex_changed = t.prototype.zIndex_changed),
        ...
        (t.prototype.draggable_changed = function () {
            this.ready_ &&
                (this.getDraggable()
                    ? this.addDragging_(this.markerWrapper_)
                    : this.removeDragListeners_());
        }),
        (t.prototype.draggable_changed = t.prototype.draggable_changed),
        ...
        (t.prototype.position_changed = function () {
            this.draw();
        }),
        (t.prototype.position_changed = t.prototype.position_changed),
        (t.prototype.getAnchor = function () {
            return this.get("anchor");
        }),
        (t.prototype.getAnchor = t.prototype.getAnchor),
        (t.prototype.setAnchor = function (t) {
            this.set("anchor", t);
        }),
        (t.prototype.setAnchor = t.prototype.setAnchor),
        (t.prototype.anchor_changed = function () {
            this.draw();
        }),
        (t.prototype.anchor_changed = t.prototype.anchor_changed),
        (t.prototype.htmlToDocumentFragment_ = function (t) {
            var e = document.createElement("DIV");
            if (((e.innerHTML = t), 1 == e.childNodes.length))
                return e.removeChild(e.firstChild);
            for (var r = document.createDocumentFragment(); e.firstChild; )
                r.appendChild(e.firstChild);
            return r;
        }),
        (t.prototype.removeChildren_ = function (t) {
            if (t) for (var e; (e = t.firstChild); ) t.removeChild(e);
        }),
        ...
        (t.prototype.addEventListener = function (t, e, r, o) {
            return (
                (o = o || !1),
                t.addEventListener(e, r, o),
                { target: t, type: e, handler: r, useCapture: o }
            );
        }),
        (t.prototype.removeEventListener = function (t) {
            t.target.removeEventListener(t.type, t.handler, t.useCapture);
        }),
        (t.prototype.content_changed = function () {
            if (this.markerContent_) {
                ...
                if (t) {
                    "string" == typeof t &&
                        ...
                        (t = this.htmlToDocumentFragment_(t))),
                        this.markerContent_.appendChild(t);
                    for (
                        var e,
                            r = this,
                            o = this.markerContent_.getElementsByTagName("IMG"),
                            i = 0;
                        (e = o[i]);
                        i++
                    )
                        this.addEventListener(e, "mousedown", function (t) {
                            r.getDraggable() &&
                                (t.preventDefault && t.preventDefault(),
                                (t.returnValue = !1),
                                console.log("image mousedown"));
                        }),
                            this.addEventListener(e, "load", function () {
                                r.draw(), console.log("image load");
                            });
                    google.maps.event.trigger(this, "domready");
                }
        ...
        (t.prototype.content_changed = t.prototype.content_changed),
        (t.prototype.setCursor_ = function (t) {
            if (this.ready_) {
                var e = "";
                -1 !== navigator.userAgent.indexOf("Gecko/")
                    ? ("dragging" == t && (e = "-moz-grabbing"),
                      "dragready" == t && (e = "-moz-grab"),
                      "draggable" == t && (e = "pointer"))
                    : (("dragging" != t && "dragready" != t) || (e = "move"),
                      "draggable" == t && (e = "pointer")),
                    this.markerWrapper_.style.cursor != e &&
                        (this.markerWrapper_.style.cursor = e);
            }
        }),
        (t.prototype.startDrag = function (t) {
            if (this.getDraggable() && !this.dragging_) {
                this.dragging_ = !0;
                var e = this.getMap();
                (this.mapDraggable_ = e.get("draggable")),
                    e.set("draggable", !1),
        ...
        (t.prototype.drag = function (t) {
            if (this.getDraggable() && this.dragging_) {
                var e = this.mouseX_ - t.clientX,
                    r = this.mouseY_ - t.clientY;
                (this.mouseX_ = t.clientX), (this.mouseY_ = t.clientY);
                var o = parseInt(this.markerWrapper_.style.left, 10) - e,
                    i = parseInt(this.markerWrapper_.style.top, 10) - r;
                (this.markerWrapper_.style.left = o + "px"),
                    (this.markerWrapper_.style.top = i + "px");
                var s = this.getOffset_(),
                    n = new google.maps.Point(o - s.width, i - s.height),
                    a = this.getProjection();
                this.setPosition(a.fromDivPixelToLatLng(n)),
        ...
        (t.prototype.removeDragListeners_ = function () {
            this.draggableListener_ &&
                (this.removeEventListener(this.draggableListener_),
        ...
        (t.prototype.addDragging_ = function (t) {
            if (t) {
                var e = this;
                (this.draggableListener_ = this.addEventListener(
                    t,
                    "mousedown",
                    function (t) {
                        e.startDrag(t), console.log("node mousedown");
                    }
                )),
                    this.setCursor_("draggable");
            }
        ...
        (t.prototype.removeDraggingListeners_ = function () {
            if (this.draggingListeners_) {
                for (var t, e = 0; (t = this.draggingListeners_[e]); e++)
        ...
        (t.prototype.getOffset_ = function () {
            ...
            if (!this.markerContent_) return r;
            var o = this.markerContent_.offsetWidth,
                i = this.markerContent_.offsetHeight;
            switch (t) {
                case e.TOP_LEFT:
                    break;
                case e.TOP:
                ...
                case e.LEFT:
                    ...
                    break;
                case e.MIDDLE:
                    (r.width = -o / 2), (r.height = -i / 2);
                    break;
                case e.RIGHT:
                    (r.width = -o), (r.height = -i / 2);
                    break;
                case e.BOTTOM_LEFT:
                    r.height = -i;
                    break;
                case e.BOTTOM:
                    (r.width = -o / 2), (r.height = -i);
                    break;
                case e.BOTTOM_RIGHT:
        ...
        (t.prototype.onAdd = function () {
            ...
            var e = this.getPanes();
            e && e.overlayMouseTarget.appendChild(this.markerWrapper_),
            ...
            if (this.ready_ && !this.dragging_) {
                ...
                if (t) {
                    var e = this.get("position"),
                        ...
                        o = this.getOffset_();
                    (this.markerWrapper_.style.top = r.y + o.height + "px"),
                        (this.markerWrapper_.style.left = r.x + o.width + "px");
                    var i = this.markerContent_.offsetHeight,
                        s = this.markerContent_.offsetWidth;
                    s != this.get("width") && this.set("width", s),
                        i != this.get("height") && this.set("height", i);
                }
            }
        }),
...
window.JetEngineMapsProvider = function () {
    ...
    this.addMarker = function (data) {
        data.position = new google.maps.LatLng(
            data.position.lat,
            data.position.lng
        );
